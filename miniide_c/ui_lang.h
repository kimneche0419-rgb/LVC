...
typedef enum {
    ...
    /* main.c — 메뉴 */
    STR_MENU_FILE, STR_MENU_NEW, STR_MENU_OPEN_FOLDER, STR_MENU_SAVE,
    ...
    /* ai_panel.c */
    STR_AI_HEADER, STR_AI_CONNECTING, STR_AI_CONNECTED_FMT,
    STR_AI_CONN_FAIL, STR_AI_CONN_FAIL_SHORT, STR_AI_BUSY,
    STR_AI_ERROR_FMT, STR_AI_USER_TAG, STR_AI_BOT_TAG,
    STR_BTN_REVIEW, STR_BTN_FIX, STR_BTN_PLAN, STR_BTN_APPLY, STR_BTN_RUN,
    STR_AI_NO_CODE, STR_AI_PLAN_HINT, STR_AI_NO_ANSWER,
    STR_AI_APPLY_CONFIRM, STR_AI_APPLIED_NOTICE,
    STR_PROMPT_REVIEW, STR_PROMPT_FIX, STR_PROMPT_PLAN_TYPED, STR_PROMPT_PLAN_CODE,
